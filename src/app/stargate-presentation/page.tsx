        ...
        <div className="relative w-[180mm] mx-auto bg-white p-2">
          ...
          <div className="border border-gray-300 rounded-xl overflow-hidden mb-6">
            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="bg-gray-100">
                  <th className="border border-gray-300 p-3 text-left w-[220px]">
                    평가항목
                  </th>
          ...
          <div className="mt-15 text-center text-sm font-semibold">
            {evaluationDate
              ? evaluationDate.replaceAll("-", " . ")
              : "평가일자 미입력"}
          </div>

          <div className="mt-15 flex justify-end items-end text-lg font-bold">
